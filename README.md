...
**Acknowledgements / inspiration.** Ideas and graph-based formulation follow recent works leveraging graph/network representations for photonic experiment design (Xuemei Gu and collaborators).
